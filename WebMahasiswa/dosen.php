...
<head>
    ...
    <title>Data Dosen - SIAKAD Universitas</title>
    ...
    <div class="main-container">
        <div class="container">
            <div class="nav-menu text-center">
                ...
                <a href="dosen.php" class="nav-item-custom active"><i class="fas fa-chalkboard-user"></i> Dosen</a>
            ...
            <div class="table-card">
                <div class="card-header-custom">
                    <h2><i class="fas fa-chalkboard-user"></i> Daftar Dosen</h2>
                    <button class="btn-add" data-bs-toggle="modal" data-bs-target="#dosenModal" onclick="siapkanTambah()"><i class="fas fa-plus-circle"></i> Tambah Dosen</button>
                </div>
                <div class="table-responsive">
                    <table class="table table-custom">
                        <thead>
                            <tr><th>No</th><th>NIDN</th><th>Nama Dosen</th><th>Alamat</th><th style="text-align:center">Aksi</th></tr>
                        </thead>
                        <tbody id="tempat-data-dosen">
                            <tr><td colspan="5" class="text-center py-4"><div class="spinner-border text-primary"></div><br>Memuat data...</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
            <div class="footer"><i class="fas fa-copyright"></i> 2024 SIAKAD Universitas</div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header" style="background: linear-gradient(135deg, #667eea, #764ba2); color: white;">
                    <h5 class="modal-title" id="modalTitle"><i class="fas fa-user-plus"></i> Form Dosen</h5>
